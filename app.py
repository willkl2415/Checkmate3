...
# Fix: ensure section values are strings and use list instead of set for JSON
for chunk in chunks_data:
    ...
    document_sections[doc].add(str(section))

# Convert sets to lists for JSON serialization
document_sections = {k: sorted(list(v)) for k, v in document_sections.items()}
